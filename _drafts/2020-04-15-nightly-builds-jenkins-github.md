...
We then remove the existing tag, if exists.
...
With this mechanism, we can start publishing nightly builds in the hope that they will provide us will earlier feedback on the upcoming features in muCommander.